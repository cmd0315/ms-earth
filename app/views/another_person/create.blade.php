...
<div class="col-lg-8 col-lg-offset-2" id="home">
	...
	<div class="panel panel-default">
		<div class="panel-body">
			...
			{{ Form::open(['role' => 'form', 'route' => ['another_person_registration.storeParticipantRegistration']]) }}
				<div class="row">
					<div class="col-lg-4">
			  	...
			  	<div class="row">
			  		<div class="col-lg-12">
			  			<input type="hidden" name="contact_person_id" id="contact_person_id" value="{{ e($contact_person->contact_person_id) }}">
